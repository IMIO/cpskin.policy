...
#    Click Element  ma-commune-services-communaux-informatique
    ...
    Capture and crop page screenshot  doc/3-3-1 création.png  id=top-navigation  id=portal-breadcrumbs  css=#content .documentFirstHeading
    ...
    Capture and crop page screenshot  doc/3-3-2 création.png  id=top-navigation  id=portal-breadcrumbs  css=#content .documentFirstHeading
